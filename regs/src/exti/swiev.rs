use crate::exti::{BASE_ADDRESS, EXTILine};
...
impl RegisterBlock {
    #[inline(always)]
    pub fn is_software_interrupt_activated(&self, exti_line: EXTILine) -> bool {
...
impl RegisterBlock {
    #[inline(always)]
    pub fn set_software_interrupt_activated(&mut self, exti_line: EXTILine, value: bool) {
